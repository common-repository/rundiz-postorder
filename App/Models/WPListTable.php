<?php
/**
 * Copy from wp-admin/includes/class-wp-list-table.php as the recommended from https://developer.wordpress.org/reference/classes/wp_list_table/
 * 
 * Steps:
 * 1. open wp-admin/includes/class-wp-list-table.php file.
 * 2. Copy from the beginning below the `namespace` (if exists) to the end of file.
